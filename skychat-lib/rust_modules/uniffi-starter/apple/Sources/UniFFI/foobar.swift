...
public struct ConvoChatWrapper {
    ...
    public init(id: Data, name: String, lastMessage: String?, unreadMessages: UInt64, globalIndex: UInt64, members: [String], decrypted: [MessageItemWrapper]) {
        self.id = id
        self.name = name
...
public struct ConvoInviteWrapper {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(groupName: String, welcomeMessage: String, ratchetTree: Data?, globalIndex: UInt64, fanned: Data?) {
...
public struct ConvoMessageWrapper {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(globalIndex: UInt64, unixTimestamp: UInt64, encrypted: Data?, invite: ConvoInviteWrapper?) {
        self.globalIndex = globalIndex
...
public struct FfiConverterTypeConvoMessageWrapper: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ConvoMessageWrapper {
        return
            try ConvoMessageWrapper(
                ...
                encrypted: FfiConverterOptionData.read(from: &buf), 
    ...
    public static func write(_ value: ConvoMessageWrapper, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionData.write(value.encrypted, into: &buf)
